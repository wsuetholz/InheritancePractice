...
public class SalaryPlusCommissionEmployeeTest {
	...
	SalaryPlusCommissionEmployee instance = new SalaryPlusCommissionEmployeeImpl("Joe C Doe", "123 45th Street", "Normal", "IL", "01/01/1969", "IT", "Peon", "Hi There", 10000.00, 24,14, 15.0f, 1500.00, 25000.00);
	...
	SalaryPlusCommissionEmployee instance = new SalaryPlusCommissionEmployeeImpl(name, "123 45th Street", "Normal", "IL", "01/01/1969", "IT", "Peon", "Hi There", 10000.00, 24,14, 15.0f, 1500.00, 25000.00);
    }
	...
	SalaryPlusCommissionEmployee instance = new SalaryPlusCommissionEmployeeImpl("Joe C Doe", "123 45th Street", "Normal", "IL", expResult, "IT", "Peon", "Hi There", 10000.00, 24,14, 15.0f, 1500.00, 25000.00);
	...
	SalaryPlusCommissionEmployee instance = new SalaryPlusCommissionEmployeeImpl("Joe C Doe", "123 45th Street", "Normal", "IL", birthday, "IT", "Peon", "Hi There", 10000.00, 24,14, 15.0f, 1500.00, 25000.00);
	...
	SalaryPlusCommissionEmployee instance = new SalaryPlusCommissionEmployeeImpl("Joe C Doe", null, "Normal", "IL", "01/01/1969", "IT", "Peon", "Hi There", 10000.00, 24,14, 15.0f, 1500.00, 25000.00);
    }
	...
	exception.expect(IllegalArgumentException.class);
	//exception.expect(containsString("Name cannot be null!"));
	SalaryPlusCommissionEmployee instance = new SalaryPlusCommissionEmployeeImpl("Joe C Doe", "123 45th Street", null, "IL", "01/01/1969", "IT", "Peon", "Hi There", 10000.00, 24,14, 15.0f, 1500.00, 25000.00);
    }
	...
	exception.expect(IllegalArgumentException.class);
	//exception.expect(containsString("Name cannot be null!"));
	SalaryPlusCommissionEmployee instance = new SalaryPlusCommissionEmployeeImpl("Joe C Doe", "123 45th Street", "Normal", null, "01/01/1969", "IT", "Peon", "Hi There", 10000.00, 24,14, 15.0f, 1500.00, 25000.00);
    }
	...
	exception.expect(IllegalArgumentException.class);
	//exception.expect(containsString("Name cannot be null!"));
	SalaryPlusCommissionEmployee instance = new SalaryPlusCommissionEmployeeImpl("Joe C Doe", "123 45th Street", "Normal", "IL", "01/01/1969", null, "Peon", "Hi There", 10000.00, 24,14, 15.0f, 1500.00, 25000.00);
    }
	...
	exception.expect(IllegalArgumentException.class);
	//exception.expect(containsString("Name cannot be null!"));
	SalaryPlusCommissionEmployee instance = new SalaryPlusCommissionEmployeeImpl("Joe C Doe", "123 45th Street", "Normal", "IL", "01/01/1969", "IT", null, "Hi There", 10000.00, 24,14, 15.0f, 1500.00, 25000.00);
    }
	...
	exception.expect(IllegalArgumentException.class);
	//exception.expect(containsString("Name cannot be null!"));
	SalaryPlusCommissionEmployee instance = new SalaryPlusCommissionEmployeeImpl("Joe C Doe", "123 45th Street", "Normal", "IL", "01/01/1969", "IT", "Peon", null, 10000.00, 24,14, 15.0f, 1500.00, 25000.00);
    }
	...
	SalaryPlusCommissionEmployee instance = new SalaryPlusCommissionEmployeeImpl("Joe C Doe", "123 45th Street", "Normal", "IL", "01/01/1969", "IT", "Peon", "Hi There", expResult, 24,14, 15.0f, 1500.00, 25000.00);
	...
	SalaryPlusCommissionEmployee instance = new SalaryPlusCommissionEmployeeImpl("Joe C Doe", "123 45th Street", "Normal", "IL", "01/01/1969", "IT", "Peon", "Hi There", annualWage, 24,14, 15.0f, 1500.00, 25000.00);
    }
	...
	long expResult = 24L;
	SalaryPlusCommissionEmployee instance = new SalaryPlusCommissionEmployeeImpl("Joe C Doe", "123 45th Street", "Normal", "IL", "01/01/1969", "IT", "Peon", "Hi There", 10000.00, expResult,14, 15.0f, 1500.00, 25000.00);
	...
	exception.expect(IllegalArgumentException.class);
	//exception.expect(containsString("Cannot have employee OWE company!"));
	SalaryPlusCommissionEmployee instance = new SalaryPlusCommissionEmployeeImpl("Joe C Doe", "123 45th Street", "Normal", "IL", "01/01/1969", "IT", "Peon", "Hi There", 10000.00, payPeriods,14, 15.0f, 1500.00, 25000.00);
    }
	...
	long expResult = 14L;
	SalaryPlusCommissionEmployee instance = new SalaryPlusCommissionEmployeeImpl("Joe C Doe", "123 45th Street", "Normal", "IL", "01/01/1969", "IT", "Peon", "Hi There", 10000.00, 24, expResult, 15.0f, 1500.00, 25000.00);
	...
	exception.expect(IllegalArgumentException.class);
	//exception.expect(containsString("Cannot have employee OWE company!"));
	SalaryPlusCommissionEmployee instance = new SalaryPlusCommissionEmployeeImpl("Joe C Doe", "123 45th Street", "Normal", "IL", "01/01/1969", "IT", "Peon", "Hi There", 10000.00, 24, vacationDays, 15.0f, 1500.00, 25000.00);
    }
	...
	SalaryPlusCommissionEmployee instance = new SalaryPlusCommissionEmployeeImpl("Joe C Doe", "123 45th Street", "Normal", "IL", "01/01/1969", "IT", "Peon", "Hi There", 10000.00, 24, 14, expResult, 1500.00, 25000.00);
	...
	exception.expect(IllegalArgumentException.class);
	//exception.expect(containsString("Cannot have employee OWE company!"));
	SalaryPlusCommissionEmployee instance = new SalaryPlusCommissionEmployeeImpl("Joe C Doe", "123 45th Street", "Normal", "IL", "01/01/1969", "IT", "Peon", "Hi There", 10000.00, 24, 14, commissionPercentage, 1500.00, 25000.00);
    }
	...
	SalaryPlusCommissionEmployee instance = new SalaryPlusCommissionEmployeeImpl("Joe C Doe", "123 45th Street", "Normal", "IL", "01/01/1969", "IT", "Peon", "Hi There", 10000.00, 24, 14, 15.0f, expResult, 25000.00);
	...
	exception.expect(IllegalArgumentException.class);
	//exception.expect(containsString("Cannot have employee OWE company!"));
	SalaryPlusCommissionEmployee instance = new SalaryPlusCommissionEmployeeImpl("Joe C Doe", "123 45th Street", "Normal", "IL", "01/01/1969", "IT", "Peon", "Hi There", 10000.00, 24, 14, 15.0f, periodGrossSales, 25000.00);
    }
	...
	SalaryPlusCommissionEmployee instance = new SalaryPlusCommissionEmployeeImpl("Joe C Doe", "123 45th Street", "Normal", "IL", "01/01/1969", "IT", "Peon", "Hi There", 10000.00, 24, 14, 15.0f, 1500.00, expResult);
	...
	exception.expect(IllegalArgumentException.class);
	//exception.expect(containsString("Cannot have employee OWE company!"));
	SalaryPlusCommissionEmployee instance = new SalaryPlusCommissionEmployeeImpl("Joe C Doe", "123 45th Street", "Normal", "IL", "01/01/1969", "IT", "Peon", "Hi There", 10000.00, 24, 14, 15.0f, 1500.00, periodTargetSales);
    }
